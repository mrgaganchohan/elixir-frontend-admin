        ...
        return(
            <tr className="d-flex">
                ...
                <td className="col-lg-3 text-center pt-2 pb-1">
                    <Link className="btn btn-outline-info cog-radius pl-4 pr-4 mr-2 pt-1 pb-1" to={`/product/view/${this.props.productInfo.id}`}><span className="fa fa-eye pr-2"></span> View</Link>
